...
class RepliesController extends BaseController
{
     ...
     *
     * @return Models\CheckRepliesResponse Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getCheckReplies(): Models\CheckRepliesResponse
    {
        //prepare query string for API call
        $_queryUrl = $this->config->getBaseUri() . '/v1/replies';
        ...
        return ApiHelper::mapClass($_httpRequest, $_httpResponse, $response->body, 'CheckRepliesResponse');
    }
     ...
     * @param Models\ConfirmRepliesAsReceivedRequest $body
     *
     * @return mixed Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function createConfirmRepliesAsReceived(string $contentType, Models\ConfirmRepliesAsReceivedRequest $body)
    {
        //prepare query string for API call
        $_queryUrl = $this->config->getBaseUri() . '/v1/replies/confirmed';
